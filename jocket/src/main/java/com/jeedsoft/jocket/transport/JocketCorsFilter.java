...
@WebFilter(servletNames={"JocketCreateServlet", "JocketPollingServlet", "JocketSendServlet"}, asyncSupported=true)
public final class JocketCorsFilter implements Filter
{
	...
	public void doFilter(ServletRequest req, ServletResponse res, FilterChain chain) throws IOException, ServletException
	{
		...
		if (request.getHeader("Referer") == null) {
			...
			if (corsRequestHeaders == null || !corsRequestHeaders.toLowerCase().contains("jocket-client")) {
